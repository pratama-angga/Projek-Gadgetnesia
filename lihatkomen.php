...
<head>
    ...
    <title>Halaman Lihat Komentar</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Komentar Artikel contoh</h1>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>User</td>
                                            <td>ini adalah contoh isi komentar</td>
                                            <td><a href="balas.php">Balas</a></td>
