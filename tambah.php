...
<body id="page-top">
    ...
    @$tambah=$_POST['tambah'];
    if ($tambah) {
        $query_insert="INSERT INTO tbl_artikel VALUES('', '$judul_artikel' ,'$gambar','$kategori','$isi_artikel');";
